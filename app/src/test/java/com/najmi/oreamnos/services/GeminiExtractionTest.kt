...
class GeminiExtractionTest {
    ...
    fun `test fallback executes when optimized path fails`() {
        ...
        // Current BUG: extractTextFromJson catches Exception and returns null, SKIPPING fallback
        // Desired Behavior: It should proceed to fallback and find "Fallback Found Me"

        val result = GeminiService.extractTextFromJson(root)

        // Asserting the INTENDED behavior (this should FAIL currently)
