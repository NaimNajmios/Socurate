 ...
 * Note: True Gemma 3 via MediaPipe/LiteRT requires model download and specific runtime setup.
 * This uses ML Kit OCR for text extraction.
 */
class Gemma3VisionExtractor(
    private val context: Context,
    private val modelManager: VisionModelManager
) : IVisionExtractor {
    override val model: VisionModel = VisionModel.GEMMA_3_4B
